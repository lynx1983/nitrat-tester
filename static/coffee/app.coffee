require [
	...
	(_, Backbone, domReady, i18n, DeviceSettings, Device, MenuScreenView, MenuItem, TemplatedScreenView, CalibrationScreenView, PreMeasurementScreenView, MeasurementResultScreenView, RadioactivityMeasurementScreenView, SplashScreenView, Environment, Measurements, Presets) ->
		domReady ->
